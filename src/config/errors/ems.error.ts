...
export namespace EMS_EMPLOYEE_ERROR {
  ...
  export type EMPLOYEE_ADMIN_NOT_DELETE = ERROR<'EMPLOYEE_ADMIN_NOT_DELETE', HttpStatus.BAD_REQUEST>;
}
...
export namespace EMS_AMBULANCE_ERROR {
  ...
  export type EMPLOYEE_ALREADY_ASSIGNED = ERROR<'EMPLOYEE_ALREADY_ASSIGNED', HttpStatus.CONFLICT>;
  export type EMPLOYEE_NOT_ASSIGNED = ERROR<'EMPLOYEE_NOT_ASSIGNED', HttpStatus.CONFLICT>;
  export type DRIVER_EMPLOYEE_ONLY = ERROR<'DRIVER_EMPLOYEE_ONLY', HttpStatus.BAD_REQUEST>;
  export type EMPLOYEE_TEAM_ROLE_INVALID = ERROR<'EMPLOYEE_TEAM_ROLE_INVALID', HttpStatus.BAD_REQUEST>;
  export type DRIVER_EMPLOYEE_ALREADY_ASSIGNED = ERROR<'DRIVER_EMPLOYEE_ALREADY_ASSIGNED', HttpStatus.BAD_REQUEST>;
}
