...
export namespace ER_PATIENT_ERROR {
  ...
  export interface PATIENT_ALREADY_DISCHARGED extends ERROR<'PATIENT_ALREADY_DISCHARGED', HttpStatus.BAD_REQUEST> {}
  export interface PATIENT_ALREADY_TRANSFERED extends ERROR<'PATIENT_ALREADY_TRANSFERED', HttpStatus.BAD_REQUEST> {}
  export interface PATIENT_ALREADY_DEATH extends ERROR<'PATIENT_ALREADY_DEATH', HttpStatus.BAD_REQUEST> {}
}
